    ...
    private void ApplyPreset(VisualTuningPreset preset)
    {
        ...
        switch (preset)
        {
            case VisualTuningPreset.Light:
                ...
                clusterThreshold = 6;
                bloodDecalScaleRange = new Vector2(0.88f, 1.01f);
                clusterBloodScaleRange = new Vector2(1.01f, 1.3f);
            ...
            case VisualTuningPreset.Cinematic:
                ...
                clusterThreshold = 6;
                bloodDecalScaleRange = new Vector2(1f, 1.2f);
                clusterBloodScaleRange = new Vector2(1.2f, 1.4f);
            ...
            case VisualTuningPreset.Gore:
                ...
                clusterThreshold = 5;
                bloodDecalScaleRange = new Vector2(1.1f, 1.3f);
                clusterBloodScaleRange = new Vector2(1.3f, 1.5f);
